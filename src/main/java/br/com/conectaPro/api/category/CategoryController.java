...
@Tag(
    name = "Category",
    description =
        "Categorias atreladas aos profissionais para classificar o tipo de serviço que executam")
public class CategoryController {
  @Autowired private CategoryService categoryService;

  @Operation(summary = "Criar entidade categoria")
  @PostMapping
  ...
  @Operation(summary = "Atualiza uma categoria pelo seu ID")
  @PutMapping("/{id}")
  public ResponseEntity<Category> update(
      @PathVariable("id") Long id, @RequestBody CategoryRequest request) {

    categoryService.update(id, request.build());
    return ResponseEntity.ok().build();
  }

  @Operation(summary = "Deleta uma categoria pelo seu ID")
  @DeleteMapping("/{id}")
