...
public interface PaymentGateway {
  ...
  /**
   * Gera a cobrança no provedor e retorna uma URL/referência de checkout para o cliente completar o
   * pagamento. No gateway fake, essa URL aponta para um endpoint interno de simulação; num gateway
   * real, seria o link de checkout do provedor.
   */
