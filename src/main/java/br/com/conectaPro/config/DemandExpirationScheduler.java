...
public class DemandExpirationScheduler {
    ...
    /**
     * Roda a cada 5 minutos e expira demandas abertas há mais de 1 hora sem resposta.
     * fixedDelay = 5 * 60 * 1000 ms
     */
    ...
    public void expirarDemandasAbertas() {
        ...
        for (Demand demand : expiradas) {
            ...
            try {
                ...
                System.err.println("[CRON] Erro ao notificar expiração da demanda "
                        + demand.getCode() + ": " + e.getMessage());
            }
        }
    }
}